...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SpaceData :  IEquatable<SpaceData>, IValidatableObject
    {
        /// <summary>
        ...
        public SpaceAttributes Attributes { get; set; }

        /// <summary>
        /// Gets or Sets Relationships
        /// </summary>
        [DataMember(Name="relationships", EmitDefaultValue=false)]
        public SpaceRelationships Relationships { get; set; }
        ...
        {
            return this.Equals(input as SpaceData);
        }

        /// <summary>
        /// Returns true if SpaceData instances are equal
        /// </summary>
        /// <param name="input">Instance of SpaceData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SpaceData input)
        {
            if (input == null)
                return false;
