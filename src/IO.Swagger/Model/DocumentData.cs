...
namespace IO.Swagger.Model
{
    ...
    public partial class DocumentData :  IEquatable<DocumentData>, IValidatableObject
    {
        ...
        public DocumentData(string Id = default(string), string Type = default(string), DocumentAttributes Attributes = default(DocumentAttributes), DocumentRelationships Relationships = default(DocumentRelationships), DocumentLink Links = default(DocumentLink))
        {
            this.Id = Id;
            this.Type = Type;
        ...
        public DocumentRelationships Relationships { get; set; }
