...
namespace IO.Swagger.Model
{
    ...
    public partial class InputPart :  IEquatable<InputPart>, IValidatableObject
    {
        ...
        public InputPart(bool? ContentTypeFromMessage = default(bool?), string BodyAsString = default(string), Dictionary<string, List<string>> Headers = default(Dictionary<string, List<string>>), MediaType MediaType = default(MediaType))
        {
