...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface INamespacesApi : IApiAccessor
    {
    ...
    public partial class NamespacesApi : INamespacesApi
    {
        ...
        /// <returns></returns>
        public NamespacesApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> AddSpaceCollaboratorsWithHttpInfo (string spaceId, TypedGenericDataRepresentationListUserData body = null)
        {
            ...
            if (spaceId == null)
                throw new ApiException(400, "Missing required parameter 'spaceId' when calling NamespacesApi->AddSpaceCollaborators");

            var localVarPath = "/api/namespaces/{spaceId}/collaborators";
        ...
        public ApiResponse<Object> DeleteUserSpaceWithHttpInfo (string spaceId)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
                throw new ApiException(400, "Missing required parameter 'spaceId' when calling NamespacesApi->DeleteUserSpace");

            var localVarPath = "/api/namespaces/{spaceId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< GenericDataRepresentationListUserData > GetSpaceCollaboratorsWithHttpInfo (string spaceId, int? offset = null, int? limit = null)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
                throw new ApiException(400, "Missing required parameter 'spaceId' when calling NamespacesApi->GetSpaceCollaborators");
        ...
        public ApiResponse< SpaceRepresentation > GetUserSpaceWithHttpInfo (string spaceId)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
                throw new ApiException(400, "Missing required parameter 'spaceId' when calling NamespacesApi->GetUserSpace");
        ...
        public ApiResponse< GenericDataRepresentationListSpaceData > GetUserSpacesWithHttpInfo (string role = null)
        {
            ...
            var localVarPath = "/api/namespaces";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse<Object> RemoveSpaceCollaboratorsWithHttpInfo (string spaceId, string userId)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
                throw new ApiException(400, "Missing required parameter 'spaceId' when calling NamespacesApi->RemoveSpaceCollaborators");
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling NamespacesApi->RemoveSpaceCollaborators");

            var localVarPath = "/api/namespaces/{spaceId}/collaborators/{userId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< SpaceRepresentation > UpdateUserSpaceWithHttpInfo (string spaceId, SpaceRepresentation body = null)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
                throw new ApiException(400, "Missing required parameter 'spaceId' when calling NamespacesApi->UpdateUserSpace");
